...
const SeatVictory = ({value,onChange,type1,type2,type3,type4,type5,type6,type7,type8,type9}) => {
    return (
        <div className='col-12 seats'>
            ...
            <div className='seat'>
                <input type="radio" value={value} id="radioNoLabel1" name={type8} onChange={onChange}/>
            </div>
            <div className='seat'>
                <input type="radio" value={value} id="radioNoLabel1" name={type9} onChange={onChange}/>
            </div>
        </div>
    )
}

export default SeatVictory